...
class MeetingTableViewController: UITableViewController {
    var meetingrooms:[String:[String:Int]] = ["first":["Ar":0,"Br":4,"Cr":5,"Dr":6,"Er":6],"second":["Ar":1,"Br":5,"Cr":6,"Dr":7,"Er":7]]
    ...
    override func viewDidLoad() {
        ...
        guard let equipmentURL = Bundle.main.url(forResource:Elist, withExtension: "plist") else {
            print("No File")
            return
        }
       
        if let eeeArray = NSDictionary(contentsOf: equipmentURL){
            //print(eArray)
            el = eeeArray as! [String : String]
            print("rere")
    ...
    @IBAction func deletecomp(_ sender: Any) {
